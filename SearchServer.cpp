...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query,
                                      PredFunc predFunc) const {
        const Query query = ParseQuery(raw_query);
        auto matched_documents = FindAllDocuments(query, predFunc);
...
private:
    ...
    template<typename PredFunc>
    vector<Document> FindAllDocuments(const Query& query, PredFunc predFunc) const {
